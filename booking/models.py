...
class Books(models.Model):
    manager=models.ForeignKey(BookManager, on_delete=models.CASCADE)
    ...
    book_image=models.ImageField(upload_to="media", height_field=None, width_field=None, max_length=None,default='0.jpeg')
    
    def __str__(self):
        return "Book No: "+str(self.id)
